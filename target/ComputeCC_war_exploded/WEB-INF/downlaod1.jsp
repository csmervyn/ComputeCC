...
<h3>下载修改后的excel表格</h3>
	<a href="<%=basePath%>downloadFile/alterTable.do">下载修改后的excel表格</a>
	<br>
	<%-- <a href="<%=basePath%>downloadFile/correlationCoefficient.do">下载相关系数excel表格</a>
	<br> --%>
	<a href="<%=basePath%>fiveStep.do">继续进行相关系数表分析</a>
	<br>
	<a href="<%=basePath%>DYHG/duoYuanHuiGuiYanZheng.do">重新进行多元回归验证</a>
	<br>
	<a href="<%=basePath%>DYHG/JXduoYuanHuiGuiYanZheng.do">继续进行多元回归验证</a>
	<br>
	<a href="<%=basePath%>">返回主页</a>
	<br>
	<c:if test="${not empty strList}">
		<div class="panel panel-success">
		  <div class="panel-heading">多元回归方程</div>
	...
	<div class="panel panel-primary">
		  <div class="panel-heading">相关系数</div>
		  <div class="panel-body">
