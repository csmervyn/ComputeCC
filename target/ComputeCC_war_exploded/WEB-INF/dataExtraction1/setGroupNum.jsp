...
<title>数据抽取-设置单组个数</title>
<!-- 最新版本的 Bootstrap 核心 CSS 文件 -->
<link href="<%=basePath%>bootstrap-3.3.7-dist/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
</head>
<body class="container">
	<h3>数据抽取-设置单组个数</h3>
	<form action="<%=basePath%>DEC1/goNextPage.do" method="post" class="form-horizontal">
		<div class="form-group">
		    <label for="groupNum" class="col-sm-2 control-label">单组个数：</label>
		    <div class="col-sm-3">
