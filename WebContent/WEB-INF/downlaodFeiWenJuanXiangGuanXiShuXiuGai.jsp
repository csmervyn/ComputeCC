...
<h3>下载修改后的excel表格</h3>
	<a href="<%=basePath%>downloadFile/alterFWJTable.do">下载修改后的excel表格</a>
	<br>
	<a href="<%=basePath%>CFCompute/duoYuanHuiGuiYanZheng.do">多元回归验证</a>
	<br>
	<a href="<%=basePath%>feiWenJuanXiangGuanXiShuXiuGai.do">继续进行非问卷数据相关系数修改</a>
	<br>
